...
# defence in depth against an attacker who can already write to memory in this process turning that
# into running their own code. Both views count toward RSS, and on a NAS that is 77 MB (measured
