...
export interface Analysis { status: string; hash?: string; deep: boolean; pages: {name: string; width: number; height: number}[]; problems: {kind: string; severity: string; message: string}[] }
