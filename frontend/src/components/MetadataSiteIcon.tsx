/** Brand SVG paths sourced from simple-icons (MIT). MangaDex/MangaBaka have no
 * simple-icons entry, so they render as monogram glyphs instead. */
...
export function MetadataSiteIcon({
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" role="img" aria-hidden="true">
      <circle cx="12" cy="12" r="11" fill="currentColor" fillOpacity={0.18} stroke="currentColor" />
      <text
        x="12"
        y="12"
        textAnchor="middle"
        dominantBaseline="central"
        fontSize={monogram.length > 1 ? 9 : 12}
        fontWeight={700}
        fill="currentColor"
      >
        {monogram}
