...
/// </summary>
public class RewindService(MangarrDbContext db, IAppSettings appSettings, TimeProvider clock)
{
        ...
        DateOnly from, DateOnly to, int utcOffsetMinutes, CancellationToken ct)
    {
        ...
        // ---- most/least read ----
        // Key by Mangarr series when matched, else by Kavita series, else by title, so
