...
/// <summary>
/// Writes a minimal but structurally valid PDF 1.4 with <c>count</c> blank pages, so tests that
/// touch a PDF chapter file exercise real PDFium parsing without dragging in a PDF-writing
/// dependency. Copied from <c>Maki.Core.Tests.PdfFixture</c>, which is internal to that project.
/// </summary>
