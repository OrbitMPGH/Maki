    ...
    public async Task GetPagesAsync_DescramblesEveryPageThroughTheDataHatch()
    {
        var factory = new FakeHttpClientFactory(
            ...
            new()
            {
                ...
                // PNG stands in for all 71 of them, since the point of this test is the plumbing
                // (Data set, Referer sent, byte count) rather than each page's real pixels.
                ["cdn-ak-img.shonenjumpplus.com/public/page/2/"] =
                    FakeHttpClientFactory.BinaryFixture("gigaviewer-tinypage.png")
            });
